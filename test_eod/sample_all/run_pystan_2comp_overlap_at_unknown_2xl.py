...
modelfile = "powerlaw_2comp_overlap_at_unknown_2xl.stan"
nChains = 16
nIterations = 1500000
nThin = 1500
nJobs = -1
...
Stan_ICs = generate.ICs_2comp_overlap_unknown_2xl([[0.25,0.75], [0.,-2.], [1.05, 2.3], 25.], Stan_data["x"], nChains)
...
with open("postSamp_all_2comp_overlap_at_unknown_2xl_"+str(index)+".txt", "w") as f:
