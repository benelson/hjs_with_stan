...
Stan_ICs = generate.ICs_2comp_2xl_overlap_alltransit([[0.35,0.65], [0.5,-1.5], [1.05, 2.3], 12.], nChains)
...
with open("postSamp_WASP_2comp_2xl_overlap." + arg + ".txt", "w") as f:
