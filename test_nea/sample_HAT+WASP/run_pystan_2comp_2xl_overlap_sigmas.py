...
filename_HAT = "planets_HAT.csv"
filename_WASP = "planets_WASP.csv"
...
data_HAT = getData.NEA_to_dict(filename_HAT)
data_WASP = getData.NEA_to_dict(filename_WASP)
data_all = combine_two_dicts(data_HAT,data_WASP)

Stan_data = getData.create_Stan_input_mixture_sigmas_alltransit(data_all)
Stan_ICs = generate.ICs_2comp_2xl_overlap_sigmas_alltransit([[0.4,0.6], [0.5,-2.0], [1.0, 2.4], 17.0], Stan_data, nChains)
